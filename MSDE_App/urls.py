...
urlpatterns = [
    ...
    path('fil/student/<str:student_code>/create_alert/', views.CreateAlertView.as_view(), name='create_alert'),
    ...
    path('fil/registrate/', views.RegistratUserView.as_view(), name='registrate'),
    path('fil/salir/', views.salir, name='salir'),
    path('fil/alerts/', views.AlertListView.as_view(), name='alerts'),
    path('fil/alerts/<str:alert_code>', views.AlertDetailView.as_view(), name='alert_detail'),
